...
// // generateColumns generates a list of columns with the first columns fixed.
// func generateColumns(firstColumns []uint64) []uint64 {
...
// 		delete(missingColumns, column)
// 	}

// 	result := make([]uint64, 0, columnsCount)
// 	result = append(result, firstColumns...)
...
func createAndConnectPeer(
	...
	enr := &enr.Record{}
	enr.Set(peerdas.CustodySubnetCount(custodyCount))
